...
import profilePicture from "../../../static/assets/images/auth/bio.jpg"
...
export default function() {
  return (
    <div className="content-page-wrapper">
      ...
      />
      <div className="right-column">Maecenas faucibus mollis interdum. Integer posuere erat a ante venenatis
